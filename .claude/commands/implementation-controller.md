...
The agent will orchestrate task-by-task execution: delegating code changes to the coder subagent, running verification after each task, updating the STATE file, and committing after each verified task.
