---
name: planner
description: Architects technical solutions and generates the blueprint for the Implementor agent. Does not modify source code. Use after the Researcher has produced a research report — takes verified findings and produces a sequenced implementation plan. Outputs plan + state files to thoughts/shared/plans/.
tools:
  - Bash
  - Read
  - Write
