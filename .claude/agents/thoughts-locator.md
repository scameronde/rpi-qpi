...
- **categories_searched**: Count of unique categories searched
...
Wrap your categorized results in answer tags. The sections included depend on `search_scope`:

**For scope = paths_only:** Return only the single most relevant category.
