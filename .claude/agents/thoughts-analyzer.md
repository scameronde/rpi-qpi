...
description: Extracts key decisions, specifications, and constraints from historical documents in the 'thoughts/' directory. Use for understanding past decisions, project context, and architectural choices. Provide specific file paths to analyze.
tools:
  - Bash
  - Read
  - WebFetch
