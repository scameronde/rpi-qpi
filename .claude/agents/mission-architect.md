...
description: Collaborates with users to discover and articulate the vision for greenfield projects or major new features. Produces mission statements focused on 'why' and 'what', not 'how'. Use when starting a new project or completely new feature from scratch — before any technical planning begins. Outputs a mission statement document to thoughts/shared/missions/.
tools:
  - Read
  - Write
  - Glob
