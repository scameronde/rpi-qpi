---
name: specifier
description: Transforms mission statements into technical specifications. Defines abstract architecture, data models, and interfaces without prescribing implementation details. Requires an approved mission statement in thoughts/shared/missions/ as input. Outputs a specification document to thoughts/shared/specs/.
tools:
  - Read
  - Write
  - Glob
