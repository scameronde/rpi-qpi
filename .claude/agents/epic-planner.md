---
name: epic-planner
description: Decomposes specifications into implementation-ready epics. Creates story-based breakdowns with research questions, acceptance criteria, and dependency tracking. Requires an approved specification in thoughts/shared/specs/ as input. Outputs one epic document per epic to thoughts/shared/epics/.
tools:
  - Read
  - Write
  - Glob
